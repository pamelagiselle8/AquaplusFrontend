  ...
  return (
    <>
      ...
      <section id="Mision&Vision" style={{position: "relative", textAlign: "center"}}>
        ...
        <div style={{ position: "absolute", top: "70%", left: "2%", right: "2%", backgroundColor: "rgba(255, 255, 255, 0.4)", justifyContent: "center", padding: "20px", borderRadius: "25px", display: "flex", gap: "20px" }}>
